...
// const BASE_PATH = "http://192.168.88.210/api".replace(/\/+$/, "");
...
export const ControllersApiFetchParamCreator = {
  ...
  uploadModulePost(params: { module: string; token: string; }, options: any = {}): FetchArgs {
    ...
    if (params["token"] == null) {
      throw new Error("Missing required parameter token when calling uploadModulePost");
    }
...
export const LocationApiFp = {
   ...
   */
  locationCitiesProvincesIdGet(params: { provincesId: string; }, options: any = {}): (fetch: FetchAPI, basePath?: string) => Promise<LocationProvinces> {
...
export const UserApiFetchParamCreator = {
  ...
  userCorporationPut(params: { token: string; payloadData?: UserCorporation; }, options: any = {}): FetchArgs {
    // verify required parameter "token" is set
    if (params["token"] == null) {
      throw new Error("Missing required parameter token when calling userCorporationPut");
    }
  ...
  userLogoutCloseotherGet(params: { token: string; }, options: any = {}): FetchArgs {
    // verify required parameter "token" is set
    if (params["token"] == null) {
      throw new Error("Missing required parameter token when calling userLogoutCloseotherGet");
    }
  ...
  userLogoutGet(params: { token: string; }, options: any = {}): FetchArgs {
    // verify required parameter "token" is set
    if (params["token"] == null) {
      throw new Error("Missing required parameter token when calling userLogoutGet");
    }
  ...
  userPersonalPut(params: { token: string; payloadData?: UserPersonalPayload; }, options: any = {}): FetchArgs {
    // verify required parameter "token" is set
    if (params["token"] == null) {
      throw new Error("Missing required parameter token when calling userPersonalPut");
    }
  ...
  userPingGet(params: { token: string; }, options: any = {}): FetchArgs {
    // verify required parameter "token" is set
    if (params["token"] == null) {
      throw new Error("Missing required parameter token when calling userPingGet");
    }
