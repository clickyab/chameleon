...
import {Upload, Row, Col, notification, Progress, Button, Form, Spin, Modal} from "antd";
            ...
            <div dir={CONFIG.DIR} className="upload-content">
                ...
                <Row type="flex" gutter={16}>
                    ...
                    <Col span={24} className={"column-border-bottom"}>
                        ...
                        {!this.state.moreUploadOption &&
                        <div className="mb-2">
                            <a onClick={() => this.setState({moreUploadOption: !this.state.moreUploadOption})}><Translate value={"+show more option"}/></a>
                        </div>
                        }
                    </Col>
                    <Col span={8}>
                ...
                <Modal
                    ...
                    <div>
                        <Cropper source={this.imageType === IMG_TYPE.IMAGE_VER ? this.state.imgVerUrlOriginal : (this.imageType === IMG_TYPE.IMAGE_HOR) ? this.state.imgHorUrlOriginal : this.imageType === IMG_TYPE.LOGO ? this.state.logoUrlOriginal : this.state.iconUrlOriginal }
...
export default Form.create<IProps>()(withRouter(UploadUniversalApp as any));