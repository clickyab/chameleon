...
class CheckPublishComponent extends React.Component <IProps, IState> {
    ...
    private handleSubmit() {
        ...
        controllApi.campaignFinalizeIdPut({
            ...
            this.props.history.push("/my/campaign/list");
        }).catch(error => {
            notification.error({
            ...
            <div dir={CONFIG.DIR} className="campaign-content check-publish">
                <Row className="campaign-title">
                    <Col>
                        ...
                        <p><Translate
                            value={"before save please check all information such as, budget , start and end time , ..."}/>
                        </p>
                    </Col>
                </Row>
                    ...
                    <Col span={12}>
                        ...
                        <Row className="summary-field-wrapper">
                            <Col span={16} className="summary-info">
                                ...
                                {this.state.currentCampaign.attributes.region && this.state.currentCampaign.attributes.region.length > 0 && this.state.currentCampaign.attributes.region[0] !== "foreign" &&
                                <span>{this.state.locations.join(" / ")}</span>
                                }
                                {!this.state.currentCampaign.attributes.region && "-"}
                            </Col>
                            <Col span={8}>
                                <label><Translate value={"Regions"}/></label>
                            </Col>
                        </Row>
                        <Row className="summary-field-wrapper">
                            <Col span={16} className="summary-info">
                                ...
                                {!this.state.currentCampaign.attributes.device && "-"}
                            </Col>
                            <Col span={8}>
                    ...
                    <Col span={12}>
                        ...
                        <Row className="summary-field-wrapper">
                            <Col span={16} className="summary-info">
                                ...
                                {this.state.currentCampaign.inventory_type === "black_list" &&
                ...
                <Row type="flex" align="middle">
                    <StickyFooter isSave={true} nextAction={this.handleSubmit.bind(this)}
                                  backAction={this.handleBack.bind(this)}/>
                </Row>
            </div>
        );
    }
