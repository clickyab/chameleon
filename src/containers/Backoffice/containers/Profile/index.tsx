    ...
    const UserInfo = () => {
      return (
        <div className="user-area-information">
          ...
          <Button type="primary"><span className="button-text"><Translate
            value={"Login with impersonate mode"}/></span></Button>
          <span className={"mt-4 mb-1"}>
            <Translate
            value={"You can suspend user any time with following button in case of rules violation"}/>
          </span>
          <Button type="danger"><span className="button-text"><Translate
            value={"Deactivate user account"}/></span></Button>
        </div>
      );
    };
    const OtherInfo = () => {
              ...
              <Col span={18}>
                <Col span={24} className={"user-edit-wrapper"}>
                  <Row gutter={16} type="flex" align="top">
                    ...
                    <Col span={12}>
                      <FormItem>
                        <span className="input-title require"><Translate value="Contact point name"/></span>
                        {getFieldDecorator("first_name", {
                          initialValue: this.state.user.first_name,
                          rules: [{
                            required: true,
                    ...
                    <Col span={12}>
                      <FormItem>
                        <span className="input-title require"><Translate value="contact point last name"/></span>
                        {getFieldDecorator("last_name", {
                          initialValue: this.state.user.last_name,
                          rules: [{
                            required: true,
                  ...
                  <Row gutter={16} type="flex" align="top">
                    ...
                    <Col span={12}>
                      <FormItem>
                        <span className="input-title"><Translate value="Corporation phone"/></span>
                        {getFieldDecorator("land_line", {
                          initialValue: this.state.user.land_line,
                        })(
                          <Input
                    ...
                    <Col span={12}>
                      <FormItem>
                        <span className="input-title"><Translate value="Corporation postal Code"/></span>
                        {getFieldDecorator("postal_code", {
                          initialValue: this.state.user.postal_code,
                        })(
                          <Input
                  ...
                  <Row gutter={16} type="flex" align="top">
                    <Col span={24}>
                      <FormItem>
                        <span className="input-title"><Translate value="Corporation address"/></span>
                        {getFieldDecorator("address", {
                          initialValue: this.state.user.address,
                        })(
                          <Input
                  ...
                  <Row gutter={16} type="flex" align="top">
                    ...
                    <Col span={12}>
                      <FormItem>
                        <span className="input-title require"><Translate value="Legal name(Corporation name)"/></span>
            ...
            <Col span={24} className={"user-edit-wrapper"}>
              <Row gutter={16} type="flex" align="top">
                <div className="input-btn-wrapper">
                  ...
                  <Button type={"primary"} disabled={this.state.buttonDisable}><Translate
