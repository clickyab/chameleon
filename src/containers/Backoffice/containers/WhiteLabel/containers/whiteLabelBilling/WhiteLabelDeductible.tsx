...
class WhiteLabelDeductible extends React.Component<IProps, IState> {
                    ...
                    <Col span={17}>
                        <div>
                            ...
                            <Row type="flex" align="middle" className="payment-box">
                                ...
                                <Col className="payment-content" span={6}>
                                    <Translate value={"Amount of account after deducting"}/>
                                    <span
...
export default Form.create()(WhiteLabelDeductible);
